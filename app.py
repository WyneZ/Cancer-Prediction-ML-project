...
with tab2:
    ...
    **Clinical Context**:  
    ...
    - Current distribution: **{diagnosis_counts[0]} benign** ({diagnosis_counts[0]/sum(diagnosis_counts)*100:.1f}%) vs **{diagnosis_counts[1]} malignant** ({diagnosis_counts[1]/sum(diagnosis_counts)*100:.1f}%).
    """)
